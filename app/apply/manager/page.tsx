...
export default function ApplyManager() {
  ...
  return (
    <main className="max-w-md mx-auto p-6 space-y-4">
      <h1 className="text-2xl font-semibold">Bewerbung (Manager-Link)</h1>
      ...
      <p className="text-sm text-gray-600">Dieser Link erfasst die <strong>Leadquelle Manager: {manager}</strong>.</p>
    </main>
  );
}
