...
export default async function AdminOverview() {
  ...
  const mgrEntries = Object.entries(byManager);
  return (
    <main className="p-6 space-y-6">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          {statusEntries.length === 0 && <div className="text-gray-500">Keine Daten</div>}
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          {mgrEntries.length === 0 && <div className="text-gray-500">Keine Daten</div>}
          {mgrEntries.map(([k,v]) => (
            <div key={k} className="rounded-lg ring-1 ring-gray-200 p-3">
