...
export default async function Leads2Page() {
  ...
  return (
    <main className="p-6 space-y-4">
      ...
      <p className="text-gray-600 text-sm">Diese Ansicht berechnet <strong>Follow-up-Daten (+5 Tage)</strong> automatisch, bietet <strong>Filter</strong> und zeigt Live-Status.</p>
      <LeadTable rows={rows} />
    </main>
  );
}
